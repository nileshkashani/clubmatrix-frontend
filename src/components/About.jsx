...
const About = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0d1117] text-white px-6 py-12 flex flex-col items-center overflow-hidden">
      {/* Dotted background */}
      <div
      ...
      <div className="mb-6 w-full max-w-6xl flex justify-between items-center">
        <button
          onClick={() => navigate("/")}
          className="flex items-center text-blue-400 hover:text-blue-600 font-medium"
        >
          ← Back
        </button>
      </div>
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Website Flow Card */}
        <div className="bg-[#161b22] p-6 rounded-xl shadow-xl border border-[#2a2c38]">
        ...
        <div className="bg-[#161b22] p-6 rounded-xl shadow-xl border border-[#2a2c38]">
          ...
          <div className="space-y-4">
            {/* Member */}
            <div className="bg-[#0d1117] p-4 rounded-lg border border-[#2a2c38]">
        ...
        {/* Goal Card */}
        <div className="bg-[#161b22] p-6 rounded-xl shadow-xl border border-[#2a2c38] md:col-span-2">
