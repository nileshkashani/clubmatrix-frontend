...
const Footer = () => {
  return (
    <footer className="bg-[#0d1117] text-gray-300 py-10 overflow-hidden w-full">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a
                href="https://nileshkashani.github.io/portfolio"
                target="_blank"
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-sm mt-2 text-gray-400 text-start">
            © {new Date().getFullYear()} ClubMatrix. All rights reserved.
          </p>
          <div className="flex space-x-4 mt-4">
            ...
            <a
              href="https://linkedin.com/in/nilesh-kashani"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white"
            >
            ...
            <a
              href="https://instagram.com/nilesh_____45"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white"
            >
